...
export default class ButtonCtrl extends EventEmitter {
    constructor(el) {
        ...
        this.DOM = {el: el};
        this.DOM.text = this.DOM.el.querySelector('.btn-cta__text');
        this.DOM.textinner = this.DOM.el.querySelector('.btn-cta__text-inner');
        this.DOM.deco = this.DOM.el.querySelector('.btn-cta__deco');
        this.DOM.filler = this.DOM.deco.querySelector('.btn-cta__deco-filler');
    ...
    enter() {
        ...
        this.DOM.el.classList.add('btn-cta--hover');
    ...
    leave() {
        ...
        this.DOM.el.classList.remove('btn-cta--hover');
