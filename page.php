...
if ( have_posts() ) :
	while ( have_posts() ) :
		...
		<article id="post-<?php the_ID(); ?>" <?php post_class( 'relative overflow-hidden flex flex-col md:flex-row xl:flex-row min-h-dvh' ); ?>>
			<div class="page-single-content-wrapper bg-light w-full md:w-1/3 xl:w-2/3 pt-[69px] md:pt-[80px] px-8 xl:px-16 pb-16 order-2 md:order-1">
			...
			<aside class="w-full md:w-2/3 xl:w-1/3  relative right-0 top-0 bg-light z-[1] order-1 md:order-2 pt-[69px] md:pt-[80px]">
