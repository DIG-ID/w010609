...
gsap__WEBPACK_IMPORTED_MODULE_2__.gsap.ticker.add(function (time) {
  lenis.raf(time * 1000);
});
gsap__WEBPACK_IMPORTED_MODULE_2__.gsap.ticker.lagSmoothing(0);
gsap__WEBPACK_IMPORTED_MODULE_2__.gsap.registerPlugin(gsap_ScrollTrigger__WEBPACK_IMPORTED_MODULE_1__.ScrollTrigger);
...
function initial_timeline() {
  var hero_tl = gsap__WEBPACK_IMPORTED_MODULE_2__.gsap.timeline({
    defaults: {
      opacity: 0,
      autoAlpha: 0
    }
  });
  hero_tl.from("#header-main", {
    y: -100,
    duration: 0.6
  }).from(".section-hero .fixed-assets__text--left", {
    x: -40,
    duration: 0.8
  }, '<').from(".section-hero .fixed-assets__text--right", {
    x: 40,
    duration: 0.8
  }, '<').from(".section-hero .fixed-assets__numbers", {
    opacity: 0,
    duration: 1
  }, '<').from(".section-hero .hero-image", {
    y: 100,
    duration: 1
  }, 0.4).from(".section-hero .icons", {
    duration: 1,
    opacity: 0
  }, 0.8).from(".section-hero .brandname", {
    y: -80,
    duration: 1
  }, 0.9).from(".section-hero .available-text--01", {
    x: 80,
    duration: 1
  }, 0.9).from(".section-hero .available-text--02", {
    x: -80,
    duration: 1
  }, 0.9).from(".section-hero .triangle", {
    duration: 2,
    opacity: 0
  }, 0.9).from(".section-hero .btn-cta-wrapper", {
    duration: 1,
    scale: 2,
    ease: "power4.inOut"
  }, 1);
...
var hero_onScroll_tl = gsap__WEBPACK_IMPORTED_MODULE_2__.gsap.timeline({
  scrollTrigger: {
...
hero_onScroll_tl.to('.section-hero .brandname', {
  y: -200,
  opacity: 0,
  autoAlpha: 0,
  duration: 1
}).to('.section-hero .available-text--01', {
  x: -200,
  opacity: 0,
  autoAlpha: 0,
  duration: 2
}, '<').to('.section-hero .available-text--02', {
  x: 200,
  opacity: 0,
  autoAlpha: 0,
  duration: 2
}, '<').to('.section-hero .triangle', {
  y: 40,
  opacity: 0,
  autoAlpha: 0,
  duration: 2
...
gsap__WEBPACK_IMPORTED_MODULE_2__.gsap.from('.image-03', {
  scrollTrigger: {
...
gsap__WEBPACK_IMPORTED_MODULE_2__.gsap.from('.image-02', {
  scrollTrigger: {
    trigger: '.section-middle',
    scrub: 1,
    start: 'top 30%',
...
var footer_tl = gsap__WEBPACK_IMPORTED_MODULE_2__.gsap.timeline({
  scrollTrigger: {
...
footer_tl.from('.section-footer .image-04', {
  y: 200,
  opacity: 0,
  autoAlpha: 0,
  duration: 2
}).from('.section-footer  .text-brandname-wrapper .icons', {
  opacity: 0,
  autoAlpha: 0,
  duration: 1
}, '<').from('.section-footer .brandname', {
  y: -200,
  opacity: 0,
  autoAlpha: 0,
  duration: 2
}, '<').from('.section-footer .available-text--01', {
  x: -200,
  opacity: 0,
  autoAlpha: 0,
  duration: 3
}, '<').from('.section-footer .available-text--02', {
  x: 200,
  opacity: 0,
  autoAlpha: 0,
  duration: 3
}, '<').from('.section-footer .triangle', {
  y: 40,
  opacity: 0,
  autoAlpha: 0,
  duration: 1
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkw010609_lp"] = self["webpackChunkw010609_lp"] || [];
