<section class="section-hero h-svh overflow-hidden">
	<div class="fixed-assets">
		...
		<div class="fixed-assets__numbers font-neueMachina text-lg text-light tracking-[1.62px] fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full h-svh py-32 px-12 flex flex-col justify-around prevent-select z-10">
	...
	<div class="content flex flex-col justify-between items-center w-full h-svh">
		...
		<div class="flex flex-col items-center mt-36 z-20 text-brandname-wrapper">
			<svg xmlns="http://www.w3.org/2000/svg" width="95" height="20" viewBox="0 0 95 20" fill="none" class="icons mb-24">
			...
			<h1 class="brandname font-neueMachina font-normal font-outline text-[200px] text-transparent tracking-[18px] uppercase stroke-light text-center leading-none"><?php esc_html_e( 'W 01 06 09', 'w010609-lp' ); ?></h1>
		</div>
