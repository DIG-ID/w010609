<section class="section-footer h-full overflow-hidden py-12 relative">
	<div class="content flex flex-col justify-between items-center w-full h-svh">
		...
		<div class="flex flex-col items-center mt-36 z-20 text-brandname-wrapper">
			...
			<h2 class="brandname font-neueMachina font-normal font-outline text-[200px] text-transparent tracking-[18px] uppercase stroke-light text-center leading-none"><?php esc_html_e( 'W 01 06 09', 'w010609-lp' ); ?></h2>
		</div>
