<section class="section-footer xl:h-svh overflow-hidden relative min-h-[575px] xl:min-h-[auto] mt-48">
	<div class="content flex flex-col justify-between items-center w-full xl:h-svh h-full">
		...
		<div class="xl:flex xl:visible flex-col items-center mt-20 xl:mt-36 z-20 text-brandname-wrapper hidden invisible">
		...
		<div class="xl:visible xl:flex flex-col justify-center items-center available-text-wrapper hidden invisible">
