<section class="section-middle xl:py-40">
	<div class="flex flex-col xl:flex-row justify-center items-start xl:gap-x-44">
		<?php
		$image_02 = get_field( 'image_02', 'options' );
		if ( $image_02 ) :
			?>
			<figure class="image-02 flex flex-col mt-24 xl:mt-[30%] order-2 xl:order-1 px-12 xl:px-0">
