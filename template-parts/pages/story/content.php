...
<div class="w-full xl:hidden xl:invisible mb-32 px-8 xl:px-16">
	...
	if ( have_rows( 'videos_video' ) ) :
		...
		while ( have_rows( 'videos_video' ) ) :
			the_row();
			?>
			<div class="video-wrapper mb-10 md:mb-28">
				<h2 class="font-neueMachina font-normal text-red text-base xl:text-[22px] leading-[29px] uppercase mb-6 md:mb-9"><?php the_sub_field( 'title' ); ?></h2>
				<div class="embed-container">
					<?php
					$vfile = get_sub_field( 'video' );
					if ( $vfile ) :
