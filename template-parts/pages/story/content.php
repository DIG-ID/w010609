<section class="section-the-story flex flex-col md:flex-row xl:flex-row">
	<div class="w-full md:w-1/3 xl:w-2/3 mt-[84px] px-16 pb-16 order-2 md:order-1">
		<div class="flex md:flex-col xl:flex-row mb-52">
			...
			<figure class="mt-10 order-1 xl:order-2 max-w-[90px] xl:max-w-full self-end xl:self-start">
	...
	<aside class="w-full md:w-2/3 xl:w-1/3 relative xl:fixed right-0 top-0 h-full bg-light z-[1] order-1 md:order-2">
